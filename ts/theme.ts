// Inject a retro pixel-art inspired theme.
// Opinionated: strong borders, limited color palette, chunky pixels, monospace.
...
export const injectRetroTheme = () => {
  if (document.getElementById('retro-theme')) return;
